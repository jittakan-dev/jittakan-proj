  ...
  return (
    <>
      ...
      <div className="flex flex-row sx:flex-col smr:flex-col 2xl:flex-row w-full border-b-4 border-darkLGB bg-whiteY">
        <div className="flex flex-col w-5/12 sx:w-full smr:w-full sm:w-5/12 md:w-5/12 lg:w-4/12 xl:w-4/12 2xl:w-4/12">
          ...
          <div className="flex flex-col w-full justify-center items-start border-t-3 sx:border-t-3 smr:border-t-3 sm:border-t-0 md:border-t-0 lg:border-t-0 xl:border-t-0 2xl:border-t-0 border-darkLGB">
            <div className="flex flex-col w-full h-fit justify-center items-center p-10 sx:p-10 smr:p-10 sm:p-6 md:p-6 lg:p-10 xl:p-10 2xl:p-10 border-b-3 border-darkLGB bg-mustard">
              <p className="pl-2 pt-10 sx:pt-0 smr:pt-0 sm:pt-10 md:pt-10 lg:pt-10 xl:pt-10 2xl:pt-10 text-3xl sx:text-2xl smr:text-2xl sm:text-1.5xl md:text-2xl lg:text-2xl xl:text-2xl 2xl:text-3xl border-l-8 border-darkLGB">
                Jittakan Suwannakhon
              </p>
            </div>
            <div className="flex flex-col w-full h-fit justify-center items-center p-10 sx:p-10 smr:p-10 sm:p-6 md:p-6 lg:p-10 xl:p-10 2xl:p-10 text-1.5xl sx:text-lg smr:text-xl sm:text-lg md:text-xl lg:text-xl xl:text-xl 2xl:text-1.5xl bg-whiteG ">
            ...
            <div className="flex flex-col justify-center items-center p-10 sx:p-10 smr:p-10 sm:p-6 md:p-6 lg:p-10 xl:p-10 2xl:p-10 py-6 w-full border-y-3 border-darkLGB text-white bg-olive">
              <p className="w-full font-bold pb-2 mb-4 text-4xl sx:text-2xl smr:text-2xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-4xl border-b-4 border-white">
                Goals
              </p>
              <div className="flex flex-row sx:flex-row smr:flex-row sm:flex-col md:flex-row lg:flex-row xl:flex-row 2xl:flex-row justify-start items-center sx:items-center smr:items-center sm:items-start md:items-center lg:items-center xl:items-center 2xl:items-center w-full text-left">
                <span className="font-semibold text-6xl sx:text-5xl smr:text-5xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-6xl 2xl:text-6xl">
                ...
                <span className="font-semibold text-3xl sx:text-2xl smr:text-2xl sm:text-2xl md:text-2xl lg:text-2xl xl:text-3xl 2xl:text-3xl">
                  Ongoing
                </span>
              </div>
              <div className="flex flex-row sx:flex-row smr:flex-row sm:flex-col md:flex-row lg:flex-row xl:flex-row 2xl:flex-row justify-start items-center sx:items-center smr:items-center sm:items-start md:items-center lg:items-center xl:items-center 2xl:items-center w-full text-left">
              ...
              <p className="w-full pt-4 mt-4 text-right text-2xl sx:text-2xl smr:text-2xl sm:text-2xl md:text-2xl lg:text-2xl xl:text-2xl 2xl:text-2xl border-t-4 border-white">
        ...
        <div className="flex flex-col w-7/12 sx:w-full smr:w-full sm:w-7/12 md:w-7/12 lg:w-8/12 xl:w-8/12 2xl:w-8/12 p-10 sx:p-6 smr:p-10 sm:p-4 md:p-6 lg:p-8 xl:p-8 2xl:p-10 border-l-4 sx:border-l-0 smr:border-l-0 2xl:border-l-4 border-darkLGB bg-whiteDY ">
      ...
      >
        <div className="flex flex-col w-8/12 sx:w-full smr:w-full sm:w-8/12 2xl:w-8/12 h-full border-t-3 border-darkLGB">
          ...
          >
            <div className="flex">
              ...
              <div className="flex flex-col w-full p-10 sx:p-6 smr:p-10 sm:p-4 md:p-6 lg:p-8 2xl:p-10">
                <div className="mb-4 md:mb-2 lg:mb-3 pb-4 md:pb-2 lg:pb-3 font-semibold text-2xl sm:text-lg md:text-xl lg:text-2xl xl:text-2xl 2xl:text-2xl text-right sx:text-center smr:text-center 2xl:text-right border-b-3 border-darkLGB">
                  Ongoing Goals
                </div>
          ...
          >
            <div className="flex">
              ...
              <div className="flex flex-col w-full p-10 sx:p-6 smr:p-10 sm:p-4 md:p-6 lg:p-8 2xl:p-10">
                <div
                  className="mb-4 md:mb-2 lg:mb-3 xl:mb-4 2xl:mb-4 pb-4 md:pb-2 lg:pb-3 xl:pb-4 2xl:pb-4 font-semibold text-2xl sm:text-lg md:text-xl lg:text-2xl xl:text-2xl 2xl:text-2xl 
        ...
        >
          <div className="flex flex-col w-full py-10 text-left sx:text-center smr:text-center 2xl:text-left text-2xl sx:text-xl smr:text-xl sm:text-base md:text-base-l lg:text-lg xl:text-xl 2xl:text-2xl">
      ...
      <div className="flex w-full h-full p-10 sx:p-2 smr:p-2 sm:p-2 md:p-2 lg:p-10 xl:p-10 2xl:p-10 bg-whiteY"></div>
    </>
  );
};
